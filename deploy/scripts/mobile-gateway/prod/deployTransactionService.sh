...
applicationName="transaction-service"
applicationVersion="1.8.0-release"  #deployed artifact (nexus/artifactory/etc.)

deploymentVersion="2.2.9" #"latest"
...
dnsName="transaction-service.wexmobileauth.com"
