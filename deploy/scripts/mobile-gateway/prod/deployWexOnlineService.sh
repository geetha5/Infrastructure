...
applicationName="wexonline-service"
applicationVersion="4.14.2-release"  #deployed artifact (nexus/artifactory/etc.)

deploymentVersion="2.2.6" #"latest"
...
dnsName="wexonline-service.wexmobileauth.com"
...
stackTemplate="${templateBaseUrl}/projects/${infrastructureProject}/${deploymentType}/${deploymentVersion}/cloudformation/${applicationName}.cf.json"
