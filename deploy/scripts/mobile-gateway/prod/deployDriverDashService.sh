...
applicationName="driverdash-service"
applicationVersion="1.4.0-release"  #deployed artifact (nexus/artifactory/etc.)
...
dnsName="driverdash-service.wexmobileauth.com"
