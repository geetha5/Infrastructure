...
envInstance="sit" # short name for the instance of the platform this is being connected to, see PlatformInstance
...
aws cloudformation ${scriptTask}-stack --region ${awsRegion} --profile ${awsProfile} ${stackPolicy} \
    ...
    --parameters \
      ...
      ParameterKey=privateSubnetsCount,ParameterValue=${privateSubnetsCount} \
